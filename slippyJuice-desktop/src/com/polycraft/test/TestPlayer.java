...
public class TestPlayer {
	public static void main(String[] args) {
		...
		// creer des eqipment
		EquipmentStuff equip1 = new EquipmentStuff("Armure de bois", "blabla",
				31, 5, EquipmentType.ARMOR, Caracteristics.RESISTANCE, 21);
		EquipmentStuff equip2 = new EquipmentStuff("Pantalon de caca",
				"blablzdzdzda", 551, 5, EquipmentType.PANT,
				Caracteristics.RESISTANCE, 21);
		EquipmentStuff equip3 = new EquipmentStuff("Lunettes BG", "zzdzdzdbla",
				5, 5, EquipmentType.GLASSES, Caracteristics.SPEED, 10);
		EquipmentStuff equip4 = new EquipmentStuff("Armure de caca", "TTTT",
